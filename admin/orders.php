...
<div class="grid grid-cols-1 gap-8 sm:grid-cols-3">
               ...
               <!-- Pricing Card -->
               <div class="flex flex-col w-full p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
              <h3 class=" text-2xl font-semibold">Ahmad Raza</h3>
              <h3 class=" text-2xl ">Okara</h3>
              <h3 class=" text-2xl mb-2">03116035146</h3>


              <div class="flex justify-center items-baseline my-4">
                  <span class="mr-2 text-5xl font-extrabold">Rs.29</span>
              </div>
              <!-- List -->
